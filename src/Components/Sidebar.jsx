...
function Sidebar() {
    ...
    return (
        <>
            ...
            <ul className={theme ? `navbar-nav    ${sidebar ? 'd-none d-md-inline  ' : null}  sidebar sidebar-dark accordion darkthemesidebar ` : `navbar-nav   ${sidebar ? 'd-none d-md-inline' : null}   sidebarnew sidebar sidebar-dark accordion `} id="accordionSidebar">
